...
public class BaoKimPayment
{
    ...
    //Mã merchant site
    private string merchant_id = "11927";	//Thay bằng mã merchant site bạn đã đăng ký trên BaoKim.vn

    //Mật khẩu bảo mật
    private string secure_pass = "76c9c4650b3a3366";	//Thay bằng mật khẩu giao tiếp giữa website của bạn với BaoKim.vn
