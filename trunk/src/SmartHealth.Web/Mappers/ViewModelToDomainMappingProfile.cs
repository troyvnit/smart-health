...
namespace SmartHealth.Web.Mappers
{
    public class ViewModelToDomainMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<ProductDto, Product>().ForMember(a => a.Groups, o => o.Ignore()).ForMember(a => a.Rating, o => o.Ignore()).ForMember(a => a.RatingCount, o => o.Ignore()).ForMember(a => a.ViewCount, o => o.Ignore());
